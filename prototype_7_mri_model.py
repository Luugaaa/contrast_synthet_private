...
class MRI_Synthesis_Net(nn.Module):
    ...
    def __init__(self, scale_factor=1, num_hist_bins=256):
        ...
        # --- Image Processing Path (U-Net like) ---
        ### MODIFICATION 1 ###
        # The first convolution now accepts 2 input channels: the original image + the guidance map.
    ...
    def forward(self, x, target_hist, guidance_map):
        ...
        # --- Style Path ---
        # This part remains the same, generating the style vector for AdaIN.
        hist_features = self.histogram_processor(target_hist)
        guidance_features = self.guidance_encoder(guidance_map)
        ...
        # Downsample the 2-channel input if needed
        ...
        # The U-Net now processes the combined image and guidance map.
